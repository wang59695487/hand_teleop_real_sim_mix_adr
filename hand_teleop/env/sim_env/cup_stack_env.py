...
class CupStackEnv(BaseSimulationEnv):
    def __init__(
        self,
        use_gui=True,
        frame_skip=5,
        ...
        **renderer_kwargs
        ...
        self.target_object = load_ycb_object(self.scene, "blue_cup", scale=1.2, static=True)
    ...
    def generate_random_object_pose(self, randomness_scale):
        ...
        pos_y = random.uniform(-0.1, 0) * randomness_scale
