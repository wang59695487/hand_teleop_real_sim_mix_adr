...
class DrawerRLEnv(DrawerEnv, BaseRLEnv):
    def __init__(self, use_gui=False, frame_skip=5, robot_name="adroit_hand_free", friction=1, object_name="drawer_1", **renderer_kwargs):
    ...
    def get_visual_observation(self):
        return super().get_visual_observation()
    ...
    @cached_property
    def obs_dim(self):
        return self.robot.dof + 2 + 6 + 3 # holy shit, this should be 33 instead of 34
