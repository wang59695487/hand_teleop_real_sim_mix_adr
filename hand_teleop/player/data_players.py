...
class DcLawEnvPlayer(DataPlayer):
    def __init__(self, meta_data: Dict[str, Any], data: Dict[str, Any], env: DClawRLEnv,
                 zero_joint_pos: Optional[np.ndarray] = None):
        super().__init__(meta_data, data, env, zero_joint_pos)
...
class CupStackEnvPlayer(DataPlayer):
    def __init__(self, meta_data: Dict[str, Any], data: Dict[str, Any], env: CupStackRLEnv,
                 zero_joint_pos: Optional[np.ndarray] = None):
        super().__init__(meta_data, data, env, zero_joint_pos)
