...
class HandMocap:
    def __init__(self, checkpoint_path, smpl_dir):
        ...
        self.right_hand_mean_pose = np.array([0.1117, -0.0429, 0.4164, 0.1088, 0.0660,
        ...
        self.left_hand_mean_pose = np.array([0.11167871,  0.04289218, -0.41644183,  0.10881133, -0.06598568, -0.75622,
                                  ...
                                  0.5355592,   0.04596104, -0.27735803])
        self.mean_pose = NotImplemented
