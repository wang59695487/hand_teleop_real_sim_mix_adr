...
################################dclaw##########################################
python hand_teleop/player/play_multiple_demonstrations_act.py --backbone-type=regnet_y_3_2gf --sim-folder=sim/raw_data/dclaw --out-folder=sim/baked_data/dclaw --task-name=dclaw --frame-skip=1 --img-data-aug=1  --chunk-size=50 --sim-delta-ee-pose-bound=0.001 
...
################################Pick and Place##########################################
python hand_teleop/player/play_multiple_demonstrations_act.py --backbone-type=regnet_y_3_2gf --sim-folder=sim/raw_data/pick_place --out-folder=sim/baked_data/pick_place --task-name=pick_place --frame-skip=1 --img-data-aug=1  --chunk-size=50

nohup python main/train_act_adr.py \
    --task-name=pick_place \
    --object-name=diverse_objects \
    --sim-demo-folder=sim/raw_data/pick_place \
    --sim-dataset-folder=sim/baked_data/pick_place \
    --sim-aug-dataset-folder=sim/baked_data/pick_place_rank4 \
    --backbone-type=regnet_y_3_2gf \
    --sim-batch-size=128 \
    --lr=1e-5 \
    --kl_weight=200 \
